...
- (void)drawTitle
{
    if (!_topTitle)
    {
        ...
        _topTitle.center = CGPointMake(CGRectGetWidth(self.view.frame)/2, 50+64);
        
        //3.5inch iphone
        if ([UIScreen mainScreen].bounds.size.height <= 568 )
        {
            _topTitle.center = CGPointMake(CGRectGetWidth(self.view.frame)/2, 38+64);
...
- (void)setIsOpenFlash:(BOOL)isOpenFlash {
    ...
    [super setIsOpenFlash:isOpenFlash];
